...
- 输入目录：`D:\Docs\linelaserscan\calibration_tool\projects\daheng\outputs\ground_bias_v_experiment\input`
- 建表帧数：3
- 评估帧数：2
- 评估方式：independent holdout
- 有效补偿列数：1165
- 补偿轴：`v`
- 图像行 v 范围：9.000–2134.000 px
- 趋势保留方式：`linear`
- 跨帧聚合方式：`median`
- MAD 离群剔除阈值：3.5
- 平滑窗口：1
...
| 指标 | 补偿前 | 补偿后 |
|---|---:|---:|
| 平均剖面去趋势峰谷值 P–V | 0.393860 mm | 0.321695 mm |
| 平均剖面去趋势 RMS | 0.085779 mm | 0.037438 mm |
| 单帧 P–V 中位数 | 0.379163 mm | 0.307868 mm |
| 单帧 RMS 中位数 | 0.075097 mm | 0.033397 mm |

平均剖面 P–V 降低比例：18.32%

补偿表各列跨帧重复性 σ 中位数：0.020969 mm。
